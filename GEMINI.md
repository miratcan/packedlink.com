...
*   **`docs/development/ai-katki-rehberi.md`**: Projeye katkıda bulunan AI ajanları için kapsamlı rehber. **Ne zaman kullanılır:** İş akışı, karar alma ve katkı standartları için sürekli olarak başvurun.
